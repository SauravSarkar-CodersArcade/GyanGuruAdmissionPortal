...
def create_admission_pdf(data, folder):
    ...
    pdf.set_font("Arial", "B", 11)
    pdf.set_text_color(70,70,70)
    pdf.cell(0, 10, "Gyan Guru Pvt Ltd | [www.gyanguru.com](https://www.gyanguru.com) | +91-XXXXXXXXXX", ln=True, align="C")
    pdf.output(os.path.join(folder, "admission_record.pdf"))
...
@app.route('/download/<roll_no>/<filename>')  # <--- NEW ROUTE for file downloads!
def download_file(roll_no, filename):
    dir_path = os.path.join(app.config['UPLOAD_FOLDER'], f"NEET{roll_no}")
